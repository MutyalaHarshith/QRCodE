...
<i>How ever U can send a direct link to those files Created By @MutyalaHarshith</i>
'''
help_msg = '''
<i> Just Send me any Email Id,Text ,url etc(no media files...)</i>
<i>I will generate a Qr Code for it and send it to you Created By @MutyalaHarshith</i>
'''
...
def msg(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        update.message.reply_photo(photo=open(
            qr_file, "rb"), reply_to_message_id=message_id, caption=f"Here is Your Qr code for generated by @MutyalaHarshith and your text »'{text}'")
